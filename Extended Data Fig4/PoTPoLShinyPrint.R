...
colors <- c(B1= "#D55E00", B2="#0072B2", B3= "#AA4499", B4= "black", C="black", Ec="black", 
            E1="#009E73", E2="#009E73", E3="black", Er="black", Ha = "#FF00FF", L = "#a64dff", L2= "black", 
            Le="black", Lee="#0072B2", Lu= "#999999", M= "black", 
            O="#0072B2", P="black", Pan="#0072B2", 
...
# generate plots for chromosomes 1 through 7
    ...
    if (f == 7) {
      ...
      myPlots[[f]] <- ggplot(data = df3, aes(x = as.numeric(win_pos), y = as.numeric(divergence))) + 
        ...
        geom_line(aes(color = clade, group = Strains), size = 0.4) +
        ylim(0,0.4) +
